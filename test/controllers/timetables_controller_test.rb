...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { end_date: @timetable.end_date, group_id: @timetable.group_id, start_date: @timetable.start_date } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { end_date: @timetable.end_date, group_id: @timetable.group_id, start_date: @timetable.start_date } }
